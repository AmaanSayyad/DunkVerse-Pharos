...
const config = {
  ...
  networks: {
    pharosDevnet: {
      url: 'https://devnet.dplabs-internal.com', // Pharos Devnet RPC
      chainId: 50002, // Chain ID for Pharos Devnet
  ...
  etherscan: {
    apiKey: {
      pharosDevnet: PHAROSSCAN_API_KEY,
    ...
    customChains: [
      {
        ...
        chainId: 50002,
        urls: {
          apiURL: 'https://api.pharos.devnet.dplabs-internal.com',
